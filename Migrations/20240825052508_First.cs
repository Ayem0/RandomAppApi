    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBlocked", x => new { x.UserId, x.BlockedUserId });
                    table.ForeignKey(
                        name: "FK_UserBlocked_AspNetUsers_BlockedUserId",
                        column: x => x.BlockedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserBlocked_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFriend", x => new { x.UserId, x.FriendUserId });
                    table.ForeignKey(
                        name: "FK_UserFriend_AspNetUsers_FriendUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConversationRequest_AspNetUsers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ConversationRequest_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ConversationRequest_Conversations_ConversationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConversationRequest_ConversationId",
                table: "ConversationRequest",
                column: "ConversationId");

            migrationBuilder.CreateIndex(
                name: "IX_ConversationRequest_ReceiverId",
                table: "ConversationRequest",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_ConversationRequest_SenderId",
                table: "ConversationRequest",
                column: "SenderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBlocked_BlockedUserId",
                table: "UserBlocked",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFriend_FriendUserId",
                table: "UserFriend",
                column: "FriendUserId");
        }
